...
})(self, (__WEBPACK_EXTERNAL_MODULE__9925__, __WEBPACK_EXTERNAL_MODULE__8885__) => {
...
class Auth {
        ...
        if (resolvedAuthOptions.authCallback) {
            ...
            tokenRequestCallback = (params, cb) => {
                ...
                const authUrlRequestCallback = function (result) {
                    ...
                    if (result.error) {
                        logger_1.default.logAction(logger_1.default.LOG_MICRO, 'Auth.requestToken().tokenRequestCallback', 'Received Error: ' + Utils.inspectError(result.error));
                    }
                    else {
    ...
    async _ensureValidAuthCredentials(forceSupersede) {
        ...
        const promise = (this.waitingForTokenRequest || (this.waitingForTokenRequest = multicaster_1.default.create())).createPromise();
...
class BaseClient {
    constructor(options) {
        ...
        logger_1.default.setLog(options.logLevel, options.logHandler);
        logger_1.default.logAction(logger_1.default.LOG_MICRO, 'BaseClient()', 'initialized with clientOptions ' + platform_1.default.Config.inspect(options));
        this._MsgPack = (_c = (_b = options.plugins) === null || _b === void 0 ? void 0 : _b.MsgPack) !== null && _c !== void 0 ? _c : null;
        const normalOptions = (this.options = defaults_1.default.normaliseOptions(options, this._MsgPack));
        /* process options */
        if (normalOptions.key) {
            const keyMatch = normalOptions.key.match(/^([^:\s]+):([^:.\s]+)$/);
            if (!keyMatch) {
                const msg = 'invalid key parameter';
                logger_1.default.logAction(logger_1.default.LOG_ERROR, 'BaseClient()', msg);
        ...
        logger_1.default.logAction(logger_1.default.LOG_MINOR, 'BaseClient()', 'started; version = ' + defaults_1.default.version);
...
class BaseRealtime extends baseclient_1.default {
    ...
    constructor(options) {
        var _a, _b;
        super(defaults_1.default.objectifyOptions(options, false, 'BaseRealtime'));
...
class Channels extends eventemitter_1.default {
    ...
    async processChannelMessage(msg) {
        ...
        if (channelName === undefined) {
            logger_1.default.logAction(logger_1.default.LOG_ERROR, 'Channels.processChannelMessage()', 'received event unspecified channel, action = ' + msg.action);
            return;
        }
        const channel = this.all[channelName];
        if (!channel) {
            logger_1.default.logAction(logger_1.default.LOG_ERROR, 'Channels.processChannelMessage()', 'received event for non-existent channel: ' + channelName);
            return;
        }
...
class BaseRest extends baseclient_1.default {
     ...
     */
    constructor(options) {
        super(defaults_1.default.objectifyOptions(options, false, 'BaseRest', { Rest: rest_1.Rest }));
    }
}
...
class Connection extends eventemitter_1.default {
    ...
    get recoveryKey() {
        logger_1.default.deprecationWarning('The `Connection.recoveryKey` attribute has been replaced by the `Connection.createRecoveryKey()` method. Replace your usage of `recoveryKey` with the return value of `createRecoveryKey()`. `recoveryKey` will be removed in a future version.');
...
class DefaultRealtime extends baserealtime_1.default {
    ...
    constructor(options) {
        ...
        super(defaults_1.default.objectifyOptions(options, true, 'Realtime', Object.assign(Object.assign({}, modularplugins_1.allCommonModularPlugins), { Crypto: (_a = DefaultRealtime.Crypto) !== null && _a !== void 0 ? _a : undefined, MsgPack, RealtimePresence: {
...
class DefaultRest extends baserest_1.BaseRest {
    ...
    constructor(options) {
        ...
        super(defaults_1.default.objectifyOptions(options, true, 'Rest', Object.assign(Object.assign({}, modularplugins_1.allCommonModularPlugins), { Crypto: (_a = DefaultRest.Crypto) !== null && _a !== void 0 ? _a : undefined, MsgPack: (_b = DefaultRest._MsgPack) !== null && _b !== void 0 ? _b : undefined })));
    }
    static get Crypto() {
        if (this._Crypto === null) {
            throw new Error('Encryption not enabled; use ably.encryption.js instead');
...
class PaginatedResource {
    ...
    async handlePage(result) {
        if (result.err && returnErrOnly(result.err, result.body, this.useHttpPaginatedResponse)) {
            logger_1.default.logAction(logger_1.default.LOG_ERROR, 'PaginatedResource.handlePage()', 'Unexpected error getting resource: err = ' + Utils.inspectError(result.err));
            throw result.err;
        }
...
class RealtimeChannel extends eventemitter_1.default {
    ...
    constructor(client, name, options) {
        ...
        this.name = name;
        this.channelOptions = (0, defaults_1.normaliseChannelOptions)((_a = client._Crypto) !== null && _a !== void 0 ? _a : null, options);
        this.client = client;
        ...
        this.subscriptions = new eventemitter_1.default();
        ...
        this._allChannelChanges = new eventemitter_1.default();
    }
    invalidStateError() {
    ...
    async setOptions(options) {
        ...
        this.channelOptions = (0, defaults_1.normaliseChannelOptions)((_a = this.client._Crypto) !== null && _a !== void 0 ? _a : null, options);
    ...
    async processMessage(message) {
        ...
        switch (message.action) {
            ...
            case protocolmessage_1.actions.PRESENCE: {
                ...
                for (let i = 0; i < presence.length; i++) {
                    try {
                        ...
                        logger_1.default.logAction(logger_1.default.LOG_ERROR, 'RealtimeChannel.processMessage()', e.toString());
                    }
                }
                if (this._presence) {
            ...
            case protocolmessage_1.actions.MESSAGE: {
                //RTL17
                if (this.state !== 'attached') {
                    logger_1.default.logAction(logger_1.default.LOG_MAJOR, 'RealtimeChannel.processMessage()', 'Message "' +
                        message.id +
                ...
                if (firstMessage.extras &&
                    ...
                    const msg = 'Delta message decode failure - previous message not available for message "' +
                        ...
                        this.name +
                        '".';
                    logger_1.default.logAction(logger_1.default.LOG_ERROR, 'RealtimeChannel.processMessage()', msg);
            ...
            default:
                logger_1.default.logAction(logger_1.default.LOG_ERROR, 'RealtimeChannel.processMessage()', 'Fatal protocol error: unrecognised action (' + message.action + ')');
                this.connectionManager.abort(connectionerrors_1.default.unknownChannelErr());
        }
    }
    _startDecodeFailureRecovery(reason) {
        if (!this._lastPayload.decodeFailureRecoveryInProgress) {
            logger_1.default.logAction(logger_1.default.LOG_MAJOR, 'RealtimeChannel.processMessage()', 'Starting decode failure recovery process.');
    ...
    notifyState(state, reason, resumed, hasPresence, hasBacklog) {
        ...
        if (state === 'failed') {
            logger_1.default.logAction(logger_1.default.LOG_ERROR, action, message);
        }
        else {
            logger_1.default.logAction(logger_1.default.LOG_MAJOR, action, message);
        }
...
class RealtimePresence extends eventemitter_1.default {
    ...
    onAttached(hasPresence) {
        ...
        if (pendingPresCount) {
            this.pendingPresence = [];
            const presenceArray = [];
            const multicaster = multicaster_1.default.create();
...
function logResult(result, method, path, params) {
    if (result.err) {
        logger_1.default.logAction(logger_1.default.LOG_MICRO, 'Resource.' + method + '()', 'Received Error; ' + (0, http_1.appendingParams)(path, params) + '; Error: ' + Utils.inspectError(result.err));
    }
    else {
    ...
    static async do(method, client, path, body, headers, params, envelope, throwError) {
        ...
        async function doRequest(headers, params) {
            ...
            if (logger_1.default.shouldLog(logger_1.default.LOG_MICRO)) {
                ...
                logger_1.default.logAction(logger_1.default.LOG_MICRO, 'Resource.' + method + '()', 'Sending; ' + (0, http_1.appendingParams)(path, params) + '; Body: ' + decodedBody);
            }
...
class RestChannel {
    constructor(client, name, channelOptions) {
        var _a;
        logger_1.default.logAction(logger_1.default.LOG_MINOR, 'RestChannel()', 'started; name = ' + name);
        this.name = name;
        this.client = client;
        this.presence = new restpresence_1.default(this);
        this.channelOptions = (0, defaults_1.normaliseChannelOptions)((_a = client._Crypto) !== null && _a !== void 0 ? _a : null, channelOptions);
    }
    setOptions(options) {
        var _a;
        this.channelOptions = (0, defaults_1.normaliseChannelOptions)((_a = this.client._Crypto) !== null && _a !== void 0 ? _a : null, options);
    ...
    async history(params) {
        logger_1.default.logAction(logger_1.default.LOG_MICRO, 'RestChannel.history()', 'channel = ' + this.name);
...
class RestChannelMixin {
    ...
    static history(channel, params) {
        ...
        return new paginatedresource_1.default(client, this.basePath(channel) + '/messages', headers, envelope, async function (body, headers, unpacked) {
            return await (0, message_1.fromResponseBody)(body, options, client._MsgPack, unpacked ? undefined : format);
        }).get(params);
    }
...
class RestPresence {
    ...
    async get(params) {
        logger_1.default.logAction(logger_1.default.LOG_MICRO, 'RestPresence.get()', 'channel = ' + this.channel.name);
        ...
        return new paginatedresource_1.default(client, this.channel.client.rest.presenceMixin.basePath(this), headers, envelope, async function (body, headers, unpacked) {
            return await (0, presencemessage_1.fromResponseBody)(body, options, client._MsgPack, unpacked ? undefined : format);
        }).get(params);
    }
    async history(params) {
        logger_1.default.logAction(logger_1.default.LOG_MICRO, 'RestPresence.history()', 'channel = ' + this.channel.name);
...
class ConnectionManager extends eventemitter_1.default {
    constructor(realtime, options) {
        ...
        this.errorReason = null;
        this.queuedMessages = new messagequeue_1.default();
        this.msgSerial = 0;
        ...
        logger_1.default.logAction(logger_1.default.LOG_MICRO, 'Realtime.ConnectionManager()', 'available transports = [' + this.transports + ']');
        logger_1.default.logAction(logger_1.default.LOG_MICRO, 'Realtime.ConnectionManager()', 'http hosts = [' + this.httpHosts + ']');
    ...
    getTransportParams(callback) {
        ...
        decideMode((mode) => {
            ...
            if (mode === 'recover') {
                logger_1.default.logAction(logger_1.default.LOG_MINOR, 'ConnectionManager.getTransportParams()', 'Transport recovery mode = recover; recoveryKey = ' + this.options.recover);
    ...
    startWebSocketSlowTimer() {
        this.webSocketSlowTimer = setTimeout(() => {
            logger_1.default.logAction(logger_1.default.LOG_MINOR, 'ConnectionManager WebSocket slow timer', 'checking connectivity');
            if (this.wsCheckResult === null) {
                this.checkWsConnectivity()
                    .then(() => {
                    logger_1.default.logAction(logger_1.default.LOG_MINOR, 'ConnectionManager WebSocket slow timer', 'ws connectivity check succeeded');
                    this.wsCheckResult = true;
                })
                    .catch(() => {
                    logger_1.default.logAction(logger_1.default.LOG_MAJOR, 'ConnectionManager WebSocket slow timer', 'ws connectivity check failed');
            ...
            if (this.realtime.http.checkConnectivity) {
                Utils.whenPromiseSettles(this.realtime.http.checkConnectivity(), (err, connectivity) => {
                    if (err || !connectivity) {
                        logger_1.default.logAction(logger_1.default.LOG_MAJOR, 'ConnectionManager WebSocket slow timer', 'http connectivity check failed');
                        this.cancelWebSocketGiveUpTimer();
                        this.notifyState({
                            state: 'disconnected',
                            error: new errorinfo_1.default("new ErrorInfo('Unable to connect (network unreachable)'", 80003, 404),
                        });
                    }
                    else {
                        logger_1.default.logAction(logger_1.default.LOG_MINOR, 'ConnectionManager WebSocket slow timer', 'http connectivity check succeeded');
                    }
                });
            }
    ...
    startWebSocketGiveUpTimer(transportParams) {
        this.webSocketGiveUpTimer = setTimeout(() => {
            ...
            if (!this.wsCheckResult) {
                logger_1.default.logAction(logger_1.default.LOG_MINOR, 'ConnectionManager WebSocket give up timer', 'websocket connection took more than 10s; ' + (this.baseTransport ? 'trying base transport' : ''));
                if (this.baseTransport) {
                    ...
                    logger_1.default.logAction(logger_1.default.LOG_MAJOR, 'ConnectionManager WebSocket give up timer', 'websocket connectivity appears to be unavailable but no other transports to try');
                }
            }
    ...
    connectImpl(transportParams, connectCount) {
        ...
        if (state !== this.states.connecting.state) {
            ...
            logger_1.default.logAction(logger_1.default.LOG_MINOR, 'ConnectionManager.connectImpl()', 'Must be in connecting state to connect, but was ' + state);
            return;
        }
        ...
        if (transportPreference && transportPreference === this.baseTransport && this.webSocketTransportAvailable) {
            this.checkWsConnectivity()
                ...
                this.unpersistTransportPreference();
                if (this.state === this.states.connecting) {
                    logger_1.default.logAction(logger_1.default.LOG_MINOR, 'ConnectionManager.connectImpl():', 'web socket connectivity available, cancelling connection attempt with ' + this.baseTransport);
                    this.disconnectAllTransports();
    ...
    connectWs(transportParams, connectCount) {
        logger_1.default.logAction(logger_1.default.LOG_DEBUG, 'ConnectionManager.connectWs()');
    ...
    connectBase(transportParams, connectCount) {
        logger_1.default.logAction(logger_1.default.LOG_DEBUG, 'ConnectionManager.connectBase()');
        if (this.baseTransport) {
    ...
    tryTransportWithFallbacks(transportName, transportParams, ws, connectCount, shouldContinue) {
        logger_1.default.logAction(logger_1.default.LOG_DEBUG, 'ConnectionManager.tryTransportWithFallbacks()', transportName);
        const giveUp = (err) => {
    ...
    closeImpl() {
        ...
        if (this.pendingTransport) {
            logger_1.default.logAction(logger_1.default.LOG_MICRO, 'ConnectionManager.closeImpl()', 'Closing pending transport: ' + this.pendingTransport);
    ...
    disconnectAllTransports() {
        logger_1.default.logAction(logger_1.default.LOG_MINOR, 'ConnectionManager.disconnectAllTransports()', 'Disconnecting all transports');
        /* This will prevent any connection procedure in an async part of one of its early stages from continuing */
        this.connectCounter++;
        if (this.pendingTransport) {
            logger_1.default.logAction(logger_1.default.LOG_MICRO, 'ConnectionManager.disconnectAllTransports()', 'Disconnecting pending transport: ' + this.pendingTransport);
            this.pendingTransport.disconnect();
        }
        delete this.pendingTransport;
        if (this.proposedTransport) {
            logger_1.default.logAction(logger_1.default.LOG_MICRO, 'ConnectionManager.disconnectAllTransports()', 'Disconnecting proposed transport: ' + this.pendingTransport);
    ...
    send(msg, queueEvent, callback) {
        ...
        if (logger_1.default.shouldLog(logger_1.default.LOG_MICRO)) {
            logger_1.default.logAction(logger_1.default.LOG_MICRO, 'ConnectionManager.send()', 'queueing msg; ' + (0, protocolmessage_1.stringify)(msg, this.realtime._RealtimePresence));
        }
    ...
    processNextPendingChannelMessage() {
        if (this.pendingChannelMessagesState.queue.length > 0) {
            ...
            this.processChannelMessage(pendingChannelMessage.message)
                .catch((err) => {
                logger_1.default.logAction(logger_1.default.LOG_ERROR, 'ConnectionManager.processNextPendingChannelMessage() received error ', err);
            })
                .finally(() => {
    ...
    ping(transport, callback) {
        ...
        if (transport) {
            ...
            const pingStart = Date.now(), id = Utils.cheapRandStr();
...
class Protocol extends eventemitter_1.default {
    ...
    send(pendingMessage) {
        ...
        if (logger_1.default.shouldLog(logger_1.default.LOG_MICRO)) {
            logger_1.default.logActionNoStrip(logger_1.default.LOG_MICRO, 'Protocol.send()', 'sending msg; ' +
...
class Transport extends eventemitter_1.default {
    ...
    onProtocolMessage(message) {
        if (logger_1.default.shouldLog(logger_1.default.LOG_MICRO)) {
            logger_1.default.logActionNoStrip(logger_1.default.LOG_MICRO, 'Transport.onProtocolMessage()', 'received on ' +
                this.shortName +
                ': ' +
        ...
        switch (message.action) {
            case protocolmessage_1.actions.HEARTBEAT:
                logger_1.default.logActionNoStrip(logger_1.default.LOG_MICRO, 'Transport.onProtocolMessage()', this.shortName + ' heartbeat; connectionId = ' + this.connectionManager.connectionId);
            ...
            case protocolmessage_1.actions.AUTH:
                Utils.whenPromiseSettles(this.auth.authorize(), function (err) {
                    if (err) {
...
class DefaultMessage extends message_1.default {
    static async fromEncoded(encoded, inputOptions) {
        return (0, message_1.fromEncoded)(platform_1.default.Crypto, encoded, inputOptions);
    }
    static async fromEncodedArray(encodedArray, options) {
        return (0, message_1.fromEncodedArray)(platform_1.default.Crypto, encodedArray, options);
    }
    // Used by tests
...
class DefaultPresenceMessage extends presencemessage_1.default {
    static async fromEncoded(encoded, inputOptions) {
        return (0, presencemessage_1.fromEncoded)(encoded, inputOptions);
    }
    static async fromEncodedArray(encodedArray, options) {
        return (0, presencemessage_1.fromEncodedArray)(encodedArray, options);
    }
...
function normalizeCipherOptions(Crypto, options) {
...
async function fromEncoded(Crypto, encoded, inputOptions) {
    const msg = fromValues(encoded);
    const options = normalizeCipherOptions(Crypto, inputOptions !== null && inputOptions !== void 0 ? inputOptions : null);
...
async function fromEncodedArray(Crypto, encodedArray, options) {
...
async function fromEncoded(encoded, options) {
...
exports.fromEncoded = fromEncoded;
async function fromEncodedArray(encodedArray, options) {
    return Promise.all(encodedArray.map(function (encoded) {
...
function objectifyOptions(options, allowKeyOrToken, sourceForErrorMessage, modularPluginsToInclude) {
    if (options === undefined) {
        ...
        logger_1.default.logAction(logger_1.default.LOG_ERROR, `${sourceForErrorMessage}()`, msg);
        throw new Error(msg);
    }
    let optionsObj;
...
function normaliseChannelOptions(Crypto, options) {
...
class Logger {
    ...
    static renamedClientOption(oldName, newName) {
        Logger.deprecationWarning(`The \`${oldName}\` client option has been renamed to \`${newName}\`. Please update your code to use \`${newName}\` instead. \`${oldName}\` will be removed in a future version.`);
    }
    static renamedMethod(className, oldName, newName) {
        Logger.deprecationWarning(`\`${className}\`’s \`${oldName}\` method has been renamed to \`${newName}\`. Please update your code to use \`${newName}\` instead. \`${oldName}\` will be removed in a future version.`);
    }
...
Logger.logAction = (level, action, message) => {
    _a.logActionNoStrip(level, action, message);
};
Logger.deprecated = (description, msg) => {
...
function logResult(result, method, uri, params) {
    if (result.error) {
        logger_1.default.logActionNoStrip(logger_1.default.LOG_MICRO, 'Http.' + method + '()', 'Received Error; ' + appendingParams(uri, params) + '; Error: ' + Utils.inspectError(result.error));
    }
    else {
        logger_1.default.logActionNoStrip(logger_1.default.LOG_MICRO, 'Http.' + method + '()', 'Received; ' +
...
function logRequest(method, uri, body, params) {
    if (logger_1.default.shouldLog(logger_1.default.LOG_MICRO)) {
        logger_1.default.logActionNoStrip(logger_1.default.LOG_MICRO, 'Http.' + method + '()', 'Sending; ' +
            appendingParams(uri, params) +
            '; Body' +
        ...
        constructor(client) {
            ...
            if (platform_1.default.Config.xhrSupported && xhrRequestImplementation) {
                ...
                this.Request = async function (method, uri, headers, params, body) {
                    return new Promise((resolve) => {
                        var _a;
                        const req = xhrRequestImplementation.createRequest(uri, headers, params, body, XHRStates_1.default.REQ_SEND, (_a = (client && client.options.timeouts)) !== null && _a !== void 0 ? _a : null, method);
...
class XHRPollingTransport extends comettransport_1.default {
    ...
    createRequest(uri, headers, params, body, requestMode) {
        return xhrrequest_1.default.createRequest(uri, headers, params, body, requestMode, this.timeouts);
    }
}
...
class BufferUtils {
    ...
    hmacSha256(message, key) {
        return (0, hmac_sha256_1.hmac)(this.toBuffer(key), this.toBuffer(message));
    }
}
...
var createCryptoClass = function (config, bufferUtils) {
    ...
    class Crypto {
        ...
        static getCipher(params) {
            ...
            return {
                ...
                cipher: new CBCCipher(cipherParams, (_a = params.iv) !== null && _a !== void 0 ? _a : null),
            };
        }
    }
    ...
    class CBCCipher {
        ...
        async encrypt(plaintext) {
            logger_1.default.logAction(logger_1.default.LOG_MICRO, 'CBCCipher.encrypt()', '');
        ...
        async decrypt(ciphertext) {
            logger_1.default.logAction(logger_1.default.LOG_MICRO, 'CBCCipher.decrypt()', '');
