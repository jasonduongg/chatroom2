...
var RestPresence = class {
  ...
  async get(params) {
    ...
    return new paginatedresource_default(
      ...
      headers,
      envelope,
      async function(body, headers2, unpacked) {
...
var BaseRest = class extends baseclient_default {
   ...
   */
  constructor(options) {
    super(defaults_default.objectifyOptions(options, false, "BaseRest", { Rest }));
  }
};
...
var _DefaultRest = class _DefaultRest extends BaseRest {
  ...
  constructor(options) {
    ...
    super(
      defaults_default.objectifyOptions(options, true, "Rest", __spreadProps(__spreadValues({}, allCommonModularPlugins), {
...
var ConnectionManager = class _ConnectionManager extends eventemitter_default {
  ...
  ping(transport, callback) {
    if (transport) {
      ...
      const pingStart = Date.now(), id = cheapRandStr();
...
var Connection = class extends eventemitter_default {
  ...
  get recoveryKey() {
    logger_default.deprecationWarning(
...
var _DefaultRealtime = class _DefaultRealtime extends baserealtime_default {
  ...
  constructor(options) {
    ...
    super(
      defaults_default.objectifyOptions(options, true, "Realtime", __spreadProps(__spreadValues({}, allCommonModularPlugins), {
...
var Request = class extends eventemitter_default {
  ...
  readStream() {
    ...
    function onChunk(chunk) {
      try {
        ...
        logger_default.logAction(logger_default.LOG_ERROR, "NodeCometTransport.Request.readStream()", msg);
    ...
    res.on("end", function() {
      process.nextTick(function() {
        ...
        try {
          ...
          var msg = "Malformed response body from server: " + e.message;
          logger_default.logAction(logger_default.LOG_ERROR, "NodeCometTransport.Request.readFully()", msg);
          self2.complete(new PartialErrorInfo(msg, null, 400));
          return;
        }
  ...
  abort() {
    logger_default.logAction(logger_default.LOG_MINOR, "NodeCometTransport.Request.abort()", "");
    ...
    var req = this.req;
    if (req) {
      logger_default.logAction(logger_default.LOG_MINOR, "NodeCometTransport.Request.abort()", "aborting request");
